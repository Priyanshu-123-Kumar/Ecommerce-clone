...
import { Loader2, Eye, EyeOff, Mail, Lock, User, Store, ShoppingBag } from "lucide-react"
...
function SubmitButton() {
  ...
  return (
    <Button
      type="submit"
      disabled={pending}
      className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-6 text-lg font-semibold rounded-lg h-14 shadow-lg hover:shadow-xl transition-all duration-200"
    >
      {pending ? (
        <>
      ...
      <Card className="shadow-2xl border-0 bg-card">
        <CardHeader className="space-y-4 pb-8">
          <div className="text-center">
            <CardTitle className="text-3xl font-bold text-primary mb-2">Join Fashion Hub</CardTitle>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="space-y-3">
                <label className="block text-sm font-semibold text-foreground">I want to join as</label>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div className="text-xs opacity-75">Shop & discover</div>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <div className="text-xs opacity-75">Start your business</div>
                  </button>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-11 h-12 bg-input border-border focus:border-primary focus:ring-primary/20 rounded-lg text-base"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    minLength={6}
                    className="pl-11 pr-11 h-12 bg-input border-border focus:border-primary focus:ring-primary/20 rounded-lg text-base"
                  />
                  <button
                    type="button"
